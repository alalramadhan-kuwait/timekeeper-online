                ...
                {editing === r.id ? (
                  <div className="mt-2.5 flex items-center gap-2 flex-wrap">
                    ...
                    <button type="button" onClick={() => setEditing(null)}
                      className="inline-flex items-center gap-1 text-sm px-2.5 py-1.5 rounded-lg text-slate-500 hover:bg-slate-50">
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                ) : (
                ...
                {open && editing !== r.id && (
                  <div className="mt-2.5 flex items-center gap-2">
                    <button type="button"
                      ...
                      className="inline-flex items-center gap-1 text-sm px-2.5 py-1.5 rounded-lg
